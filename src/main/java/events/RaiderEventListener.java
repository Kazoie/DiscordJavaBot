...
public class RaiderEventListener extends ListenerAdapter {
    ...
    public void onSlashCommandInteraction(SlashCommandInteractionEvent event) {
        ...
        System.out.println("Demande d'information concernant le joueur " +name);

        String lien = "https://raider.io/api/v1/characters/profile?region=eu&realm=Ysondre&name="+name;
        try {
            ...
            } else event.reply("Erreur dans la requète").queue();
